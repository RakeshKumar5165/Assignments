...
public class StudentServiceTest {
	...
	Student student=new Student(1, "Rakesh", "Kumar", "PES", new Date(1996, 04, 12), 12345, 3, "ece");
	Student student1=new Student(0, "Sid", " koti", "PES", new Date(1994, 03, 12), 12345, 3, "cse");
	Student student2=new Student(7, "firstname", "lastname", "dummy", new Date(1994, 9, 12), 67890, 8, "cse");
	...
	{
		@SuppressWarnings("deprecation")
		Student student=new Student(1, "Rakesh", "Kumar", "JEC", new Date(1994, 03, 12), 12345, 3, "cse");
